...
# 2. 분석 엔진을 캔버스에 장착합니다 (여기에 추가)
    ...
    def _analyze_dft_electron_density(self, orca_result):
        ...
        try:
            ...
            # ✅ C5 FIX: 포터블 경로 시스템 — 하드코딩 절대 경로 제거
            ...
            self.update()  # ✅ C3 FIX: self 자체가 canvas이므로 self.update() 사용
    ...
    def paintEvent(self, event):
        ...
        if self.view_state != "Drawing":
            ...
            # ✅ M1 FIX: 조준선은 최상위 Z-INDEX 블록에서만 1회 렌더링
        ...
        if hasattr(self, 'analysis_results') and self.analysis_results:
            ...
            # ✅ M2 FIX: 디버그 print 제거 (매 프레임 출력 방지)
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # ✅ M5 FIX: Discord 보고 비활성화 (개발 단계에서 불필요)
        try:
