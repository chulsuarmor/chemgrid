...
"""
ChemDraw Pro Phase 5: Advanced Export Manager
...
class ExportMetadata:
    ...
    title: str
    software: str = "ChemDraw Pro v2.0"
...
class SelectionExporter:
    ...
    def _export_svg(self, output_path: str, bounds: QRect, settings: Dict):
        ...
        svg_gen.setTitle("ChemDraw Selection Export")
        svg_gen.setDescription(f"Exported from ChemDraw Pro - {datetime.now().isoformat()}")
