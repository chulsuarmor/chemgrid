        ...
        MechanismStep(
            ...
            arrows=[
                ...
                ArrowData("full", "bond", "P=C 이중결합",
                          "atom", "P⁺ (양전하 유지)", "#FF9800", 0.3,
                          from_atom_idx=4, to_atom_idx=3),  # P rehybridization
            ],
        ...
        MechanismStep(
            ...
            arrows=[
                ArrowData("full", "lone_pair", "H₃O⁺ → H⁺ 공여",
                          ...
                          from_atom_idx=5, to_atom_idx=2),  # H→O
                ArrowData("full", "bond", "O-Mg 결합",
                          "atom", "Mg²⁺ (이탈)", "#1565C0", 0.3,
                          from_atom_idx=2, to_atom_idx=3),  # O-Mg break
                ArrowData("full", "bond", "O-H (H₃O⁺)",
                          "atom", "H₂O 재생", "#4CAF50", 0.3,
                          from_atom_idx=5, to_atom_idx=5),  # O-H break
            ],
...
MECHANISMS["mannich_reaction"] = MechanismData(
    ...
    steps=[
        ...
        MechanismStep(
            ...
            arrows=[
                ArrowData("full", "pi_bond", "C=C(에놀)",
                          "atom", "C(이미늄)", "#E53935", 0.5,
                          from_atom_idx=2, to_atom_idx=-1),
                ArrowData("full", "pi_bond", "C=N⁺",
                          "atom", "N", "#1565C0", 0.3,
                          from_atom_idx=-1, to_atom_idx=-1),
                ArrowData("full", "bond", "O-H(에놀)",
                          "atom", "C=O", "#43A047", 0.3,
                          from_atom_idx=1, to_atom_idx=1),
            ],
            labels={"C-C 형성": "핵심"},
        ...
        MechanismStep(
            ...
            arrows=[
                ...
                ArrowData("full", "bond", "C-H 결합 → C=C",
                          ...
                          from_atom_idx=1, to_atom_idx=2),
                ArrowData("full", "bond_center", "C-OH 결합",
                          "atom", "OH⁻ (이탈기)", "#1565C0", 0.3,
                          from_atom_idx=2, to_atom_idx=0),  # C-OH → OH⁻ leaves
            ],
