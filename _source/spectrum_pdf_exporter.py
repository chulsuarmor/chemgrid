# spectrum_pdf_exporter.py (v1.0 - Professional Spectrum PDF Export)
"""
ChemDraw Pro Phase 5: Spectrum PDF Exporter
...
class SpectrumMetadata:
    ...
    chemdraw_version: str = "ChemDraw Pro v2.0"
...
class SpectrumPDFExporter:
    ...
    def _create_title_page(self) -> List:
        ...
        calc_data = [
            ...
            ["ChemDraw Version:", self.metadata.chemdraw_version],
    ...
    def _create_metadata_page(self) -> List:
        ...
        <b>Software:</b> ChemDraw Pro v2.0 with {self.metadata.software}<br/>
