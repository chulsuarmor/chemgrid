...
VINA_PATH = Path(os.environ.get("VINA_PATH", ""))
...
# Overall docking availability
DOCKING_AVAILABLE = (VINA_PYTHON_AVAILABLE or VINA_PATH.exists()) and RDKIT_AVAILABLE
